...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Weight.user'
        db.add_column(u'workouts_weight', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Set.user'
        db.add_column(u'workouts_set', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Session.user'
        db.add_column(u'workouts_session', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Weight.user'
        db.delete_column(u'workouts_weight', 'user_id')

        # Deleting field 'Set.user'
        db.delete_column(u'workouts_set', 'user_id')

        # Deleting field 'Session.user'
        db.delete_column(u'workouts_session', 'user_id')

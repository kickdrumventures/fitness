...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TargetWeight'
        db.create_table(u'workouts_targetweight', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('weight', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=1)),
        ))
        db.send_create_signal(u'workouts', ['TargetWeight'])


    def backwards(self, orm):
        # Deleting model 'TargetWeight'
        db.delete_table(u'workouts_targetweight')
    ...
    models = {
        ...
        u'workouts.targetweight': {
            'Meta': {'object_name': 'TargetWeight'},
